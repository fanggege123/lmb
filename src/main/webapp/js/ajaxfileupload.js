jQuery
		.extend( {
			...
			createUploadForm : function(id, fileElementId, data,context) {
				// create form
				...
				var oldElement = context ? jQuery('#' + fileElementId,context) : jQuery('#' + fileElementId);
			...
			ajaxFileUpload : function(s) {
				...
				var form = jQuery.createUploadForm(id, s.fileElementId,
						(typeof (s.data) == 'undefined' ? false : s.data),s.context);
